...
@Component
class ConstraintViolationTranslatorImpl : ConstraintViolationTranslator {

    override fun <T : RuntimeException> translateAndThrow(
    ...
    override fun normalizeConstraintName(constraintName: String?): String? {
