...
import com.mad.jellomarkserver.review.port.driving.DeleteReviewReplyUseCase
import org.springframework.stereotype.Service
import org.springframework.transaction.annotation.Transactional
import java.util.*

@Service
class DeleteReviewReplyUseCaseImpl(
    private val ownerPort: OwnerPort,
    private val beautishopPort: BeautishopPort,
    private val shopReviewPort: ShopReviewPort
) : DeleteReviewReplyUseCase {

    @Transactional
    override fun execute(command: DeleteReviewReplyCommand) {
        ...
        val clearedReview = review.deleteReply()
        shopReviewPort.save(clearedReview)
    }
}
